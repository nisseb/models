...
"""SSDFeatureExtractor for NASNet mobile features."""
...
class SSDNasNetMobileFeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
  """SSD Feature Extractor using NASNet features."""
  ...
  def __init__(self,
               ...
               reuse_weights=None):
    """NASNet Feature Extractor for SSD Models.
    ...
    """
    super(SSDNasNetMobileFeatureExtractor, self).__init__(
